...
const action12 = actions['func3'] = async function (store, event) {
  const state = store.state
  const action14 = await dw.app.run("auto_group_member.list", {"aggs": {}, "limit": state.limit, "offset": state.offset, "filters": {/**/  data__service_agency_uuid: state.service_agency.uuid/**/}, "order_by": []})
  if (state.offset === 0) {
...
var action41 = actions['computed1'] = function (event, state) {
  return "注册时间: " + event.item.created.slice(0, 10);
};
...
const slide = {"type":"176704","key":"c1767041","slug":null,"randomid":"id_ec881754facb74b66ffa26c3","master_pagetemplate_id":168072,"master_dataset_id":400691,"dataset_id":null,"dwapp":{},"meta":{"papp_slug":"tongzhua"},"css_ctx":{},"components":{"View1":{"ctx_map":{}},"View2":{"ctx_map":{}},"View3":{"ctx_map":{}},"View4":{"ctx_map":{}},"View5":{"ctx_map":{}},"View6":{"ctx_map":{}},"View7":{"ctx_map":{}},"View8":{"ctx_map":{}},"Image1":{"ctx_map":{"fop":"e,100,100","src":"page/gallery/lifeofpix/Life-of-Pix-free-stock-photos-wheat-sunset-people-jordanmcqueen.jpg"}},"Image2":{"ctx_map":{"fop":"e,1460,930","src":"u/dev065/2023/03/02/sjdPJMDYXdSxcFkXNX7KvX/JIKUVAZX81K8VLRAWUC.png","buildToLocal":true}},"Text12":{"ctx_map":{"text":"这是一个文本组件"}},"Text13":{"ctx_map":{"text":"这是一个文本组件"}},"Text14":{"ctx_map":{"text":"这是一个文本组件"}},"Text16":{"ctx_map":{"text":"添加员工"}},"Text17":{"ctx_map":{"text":"暂无任何数据~"}},"ViewIf1":{"ctx_map":{"value":true}},"ViewIf2":{"ctx_map":{"value":true}},"ViewIf3":{"ctx_map":{"value":true}},"ViewFor1":{"ctx_map":{"items":[{"id":1},{"id":2},{"id":3}],"itemsKey":"id"}},"ComNavBar1":{"ctx_map":{"theme":"default","title":"员工列表","headerBackgroundColor":"#ffffff","statusBarBackgroundColor":"#ffffff"}},"ScrollView1":{"ctx_map":{"type":"list","scrollX":false,"scrollY":true,"extraStyleKeys":[]}}}};

const pageGroupSlug = 'app_tongzhua-pshop_staff_list';
...
const bagForIndex = undefined
  ...
  return (
    ...
    >
      <ComNavBar title={ "员工列表" } theme={ "default" } statusBarBackgroundColor={ "#ffffff" } headerBackgroundColor={ "#ffffff" }></ComNavBar>
{!!(state.ready) /* ViewIf3 */ && (<><View /* View4 */   style={styles.xdw30c}></View>
<XbenchcScrollView /* ScrollView1 */ style={styles.xdw30q} scrollX={ false } scrollY={ true }  onRefresherRefresh={getEvent('ScrollView1:onRefresherRefresh:func4:', {}, bagForKeyValue, bagForIndex)} onScrollToLower={getEvent('ScrollView1:onScrollToLower:func5:', {}, bagForKeyValue, bagForIndex)}>{(state.items).map((bagForItem, bagForIndex) => { const bagForKeyValue = 'ViewFor1' + ':' + String(bagForItem['id']); return <ViewForItem /* ViewFor1 */ key={bagForKeyValue} bagForItem={bagForItem} bagForIndex={bagForIndex}><View /* View2 */   style={styles.xdw30k}><XbenchcImage /* Image1 */ style={styles.xdw30d} source={dwtools.qiniu(bagForItem.data.avatar, slide.components.Image1.ctx_map.fop)}  />
<View /* View1 */   style={styles.xdw30j}><View /* View6 */   style={styles.xdw30h}><Text /* Text12 */ style={styles.xdw30e} >{bagForItem.data.nickname || bagForItem.id}</Text>
{!!(bagForItem.data.role_uuid__toone) /* ViewIf1 */ && (<><View /* View5 */   style={styles.xdw30g}><Text /* Text13 */ style={styles.xdw30f} >{bagForItem.data.role_uuid__toone.data.name}</Text></View></>)}</View>
<Text /* Text14 */ style={styles.xdw30i} >{computeds.computed1({item: bagForItem}, state)}</Text></View></View>
<View /* View3 */   style={styles.xdw30l}></View></ViewForItem> })}
{!!(!state.items.length) /* ViewIf2 */ && (<><View /* View8 */   style={styles.xdw30p}><XbenchcImage /* Image2 */ style={styles.xdw30m} source={dwtools.getLocalResource('xdw30n_lthar38u')}  />
<Text /* Text17 */ style={styles.xdw30o} >{slide.components.Text17.ctx_map.text}</Text></View></>)}</XbenchcScrollView>
<XbenchcView /* View7 */   viewStyle={styles.xdw30s} onClick={getEvent('View7:onClick:func6:', {}, bagForKeyValue, bagForIndex)}><Text /* Text16 */ style={styles.xdw30r} >{slide.components.Text16.ctx_map.text}</Text></XbenchcView></>)}
    </ErrorBoundary>
  )
}
